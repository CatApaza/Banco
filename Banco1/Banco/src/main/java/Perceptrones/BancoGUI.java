...
private void createGUI() {
    ...
    frame.setSize(800, 600); // Tamaño aumentado para más espacio
    ...
    JPanel panelCajeros = new JPanel(new GridLayout(1, 2, 10, 10));
    panelCajeros.setBorder(BorderFactory.createTitledBorder("Estado de los Cajeros"));
    ...
    labelCajero1.setFont(labelFont);
    labelCajero1.setOpaque(true);
    labelCajero1.setBackground(new Color(0xC1E1FF));
    labelCajero1.setBorder(BorderFactory.createLineBorder(Color.BLACK, 1));

    labelCajero2.setFont(labelFont);
    labelCajero2.setOpaque(true);
    labelCajero2.setBackground(new Color(0xC1FFC1));
    labelCajero2.setBorder(BorderFactory.createLineBorder(Color.BLACK, 1));

    panelCajeros.add(labelCajero1);
    panelCajeros.add(labelCajero2);

    // Panel para el log de acciones y el contador de personas atendidas
    JPanel panelLog = new JPanel(new BorderLayout());
    panelLog.setBorder(BorderFactory.createTitledBorder("Log de Acciones"));
    ...
    panelContador.setBorder(BorderFactory.createTitledBorder("Contador de Personas"));
    panelContador.add(labelPersonasAtendidas);

    // Añadir componentes al panel principal
    mainPanel.add(panelCajeros, BorderLayout.NORTH);
    mainPanel.add(panelLog, BorderLayout.CENTER);
    mainPanel.add(panelContador, BorderLayout.SOUTH);
